...
import {
  ...
  gridClasses, useGridApiEventHandler, GridColumnHeaderSeparatorSides,
...
const _excluded = ['style', 'className', 'innerRef', 'visibleColumns', 'sortColumnLookup',
  'filterColumnLookup', 'columnPositions', 'columnHeaderTabIndexState', 'columnGroupHeaderTabIndexState',
  'columnHeaderFocus', 'columnGroupHeaderFocus', 'densityFactor', 'headerGroupingMaxDepth', 'columnMenuState',
  'columnVisibility', 'columnGroupsHeaderStructure', 'hasOtherElementInTabSequence', 'pinnedColumns'];
...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    leftPinnedColumns: ['pinnedColumnHeaders',
      leftPinnedColumns && leftPinnedColumns.length > 0 && 'pinnedColumnHeaders--left'],
    rightPinnedColumns: ['pinnedColumnHeaders',
      rightPinnedColumns && rightPinnedColumns.length > 0 && 'pinnedColumnHeaders--right', 'withBorderColor'],
  };
