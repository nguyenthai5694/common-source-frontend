...
import {
    GridEventListener, GridCallbackDetails, GridRowParams,
    GridRowId, GridValidRowModel, GridGroupNode, GridFeatureMode,
} from '@mui/x-data-grid';
import {
    GridExperimentalFeatures, DataGridPropsWithoutDefaultValue,
    DataGridPropsWithDefaultValues, DataGridPropsWithComplexDefaultValueAfterProcessing,
...
interface DataGridProPropsWithComplexDefaultValueBeforeProcessing extends
    Omit<DataGridPropsWithComplexDefaultValueBeforeProcessing, 'components'> {
    /**
 ...
 */
export interface DataGridProProps<R extends GridValidRowModel = any> extends
    Omit<Partial<DataGridProPropsWithDefaultValue> & DataGridProPropsWithComplexDefaultValueBeforeProcessing
        & DataGridProPropsWithoutDefaultValue<R>, DataGridProForcedPropsKey> {
}
...
export interface DataGridProProcessedProps<R extends GridValidRowModel = any>
    extends DataGridProPropsWithDefaultValue, DataGridProPropsWithComplexDefaultValueAfterProcessing,
 ...
 * None of the entry of this interface should be optional, they all have default values and 
 * `DataGridProps` already applies a `Partial<DataGridSimpleOptions>` for the public interface
 * The controlled model do not have a default value at the prop processing level, 
 * so they must be defined in `DataGridOtherProps`
 */
...
export interface DataGridProPropsWithoutDefaultValue<R extends GridValidRowModel = any>
     ...
     */
    groupingColDef?: GridGroupingColDefOverride<R> | ((params: GridGroupingColDefOverrideParams) =>
