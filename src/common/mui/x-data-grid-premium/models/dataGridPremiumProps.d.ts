...
export interface DataGridPremiumProps<R extends GridValidRowModel = any>
    extends Omit<Partial<DataGridPremiumPropsWithDefaultValue> &
        DataGridPremiumPropsWithComplexDefaultValueBeforeProcessing &
        DataGridPremiumPropsWithoutDefaultValue<R>, DataGridPremiumForcedPropsKey> {
    /**
...
export interface DataGridPremiumProcessedProps
    extends DataGridPremiumPropsWithDefaultValue, DataGridPremiumPropsWithComplexDefaultValueAfterProcessing,
 ...
 * None of the entry of this interface should be optional, they all have default values 
 * and `DataGridProps` already applies a `Partial<DataGridSimpleOptions>` for the public interface.
...
export interface DataGridPremiumPropsWithDefaultValue extends DataGridProPropsWithDefaultValue {
     ...
     * @returns {GridAggregationPosition | null} 
     * Position of the aggregated value (if `null`, the group isn't aggregated).
...
export interface DataGridPremiumPropsWithoutDefaultValue<R extends GridValidRowModel = any>
     ...
     * @param {GridCellSelectionModel} cellSelectionModel 
     * Object in the shape of [[GridCellSelectionModel]] containing the selected cells.
     * @param {GridCallbackDetails} details Additional details for this callback.
     */
