...
export interface GridRowGroupingApi {
     ...
     * @param {number | undefined} groupingIndex The grouping index at which we want to 
     * insert the new grouping criteria. By default, it will be inserted at the end of the model.
     */
     ...
     * @param {string} groupingCriteriaField The field of the grouping criteria 
     * from which we want to change the grouping index.
