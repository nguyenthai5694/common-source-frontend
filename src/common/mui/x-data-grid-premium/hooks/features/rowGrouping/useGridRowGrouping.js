...
import {
  getRowGroupingFieldFromGroupingCriteria, ROW_GROUPING_STRATEGY,
  isGroupingColumn, mergeStateWithRowGroupingModel, setStrategyAvailability,
  getGroupingRules, areGroupingRulesEqual,
...
export const rowGroupingStateInitializer = (state, props, apiRef) => {
  ...
  return _extends({}, state, {
    rowGrouping: {
      model: (_ref = (_props$rowGroupingMod = props.rowGroupingModel) != null ?
        _props$rowGroupingMod : (_props$initialState = props.initialState) == null ?
          void 0 : (_props$initialState$r = _props$initialState.rowGrouping) == null ?
            void 0 : _props$initialState$r.model) != null ? _ref : [],
    },
  });
};
...
export const useGridRowGrouping = (apiRef, props) => {
  ...
  const addRowGroupingCriteria = React.useCallback((field, groupingIndex) => {
    ...
    const updatedModel = [...currentModel.slice(0, cleanGroupingIndex),
      field, ...currentModel.slice(cleanGroupingIndex)];
  ...
  const stateExportPreProcessing = React.useCallback((prevState, context) => {
    ...
    const shouldExportRowGroupingModel =
      ...
      ((_props$initialState2 = props.initialState) == null ? void 0 :
        (_props$initialState2$ = _props$initialState2.rowGrouping) == null ?
          void 0 : _props$initialState2$.model) != null ||
  ...
  }, [apiRef, props.initialState, props.rowGroupingModel]);
  const stateRestorePreProcessing = React.useCallback((params, context) => {
    ...
    const rowGroupingModel = (_context$stateToResto = context.stateToRestore.rowGrouping) == null ?
      void 0 : _context$stateToResto.model;
