...
const getAggregationValueWrappedValueGetter = ({
  ...
  const wrappedValueGetter = params => {
    ...
    if (cellAggregationResult != null) {
      ...
      return (_cellAggregationResul = cellAggregationResult == null ?
        void 0 : cellAggregationResult.value) != null ? _cellAggregationResul : null;
    }
  ...
  const wrappedRenderCell = params => {
    ...
    if (cellAggregationResult != null) {
      ...
      const aggregationMeta = {
        hasCellUnit: (_aggregationFunction$ = aggregationRule.aggregationFunction.hasCellUnit) !=
          null ? _aggregationFunction$ : true,
...
export const wrapColumnWithAggregationValue = ({
  ...
  const getCellAggregationResult = (id, field) => {
    ...
    const groupId = cellAggregationPosition === 'inline' ?
      id : (_rowNode$parent = rowNode.parent) != null ? _rowNode$parent : '';
    const aggregationResult = (_gridAggregationLooku =
      gridAggregationLookupSelector(apiRef)) == null ? void 0
      : (_gridAggregationLooku2 = _gridAggregationLooku[groupId]) == null ? void 0 : _gridAggregationLooku2[field];
