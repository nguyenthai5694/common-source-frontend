...
import {
    GridAggregationFunction, GridAggregationModel,
    GridAggregationRule, GridAggregationRules,
...
export declare const mergeStateWithAggregationModel:
    (aggregationModel: GridAggregationModel) => (state: GridStatePremium) => GridStatePremium;
 ...
 */
export declare const addFooterRows: ({ groupingParams, apiRef, getAggregationPosition,
    hasAggregationRule }: AddFooterRowsParams) => GridHydrateRowsValue;
/**
 * Compares two sets of aggregation rules to determine if they are equal or not.
 */
export declare const areAggregationRulesEqual: (previousValue: GridAggregationRules | undefined,
    newValue: GridAggregationRules) => boolean;
