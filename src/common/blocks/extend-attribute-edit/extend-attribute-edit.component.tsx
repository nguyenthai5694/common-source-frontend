...
/**
 * @deprecated
 * deprecated. now, using extend-attribute.component.tsx
 */

export default function ExtendAttributeEdit({ isOpen, handleClose, handleSubmit, data }: ExtendAttributeEditProps) {
  const initialValues = {
  ...
  const handleSubmitAttribute = () => {
    ...
    handleSubmit(values.filter(e => e.title || e.content));
    handleClose();
  }
