...
import InventoryCalendar2Template from './inventory-calendar2.template';
...
export default class InventoryCalendar2 extends PageComponent<InventoryCalendarState> {
  ...
  render() {
    return (
      <InventoryCalendar2Template self={this} />
    )
  }
