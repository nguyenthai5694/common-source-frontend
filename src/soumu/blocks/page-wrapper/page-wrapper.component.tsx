...
import Breadcrumb, { Page } from 'soumu/blocks/breadcrumb/breadcrumb.component'
import PageError, { PageErrorType } from 'soumu/blocks/page-error/page-error.component';
import { titleSubject } from 'soumu/blocks/prompt'
import Loading from 'soumu/parts/loading/loading.component'
import PageTitle from 'soumu/parts/page-title/page-title.component'
